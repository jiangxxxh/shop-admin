<template>
  <div>
    ...
    <el-breadcrumb separator-class="el-icon-arrow-right">
      ...
      <el-breadcrumb-item>{{ breadcrumbMenu }}</el-breadcrumb-item>
      <el-breadcrumb-item>{{ breadcrumbSubMenu }}</el-breadcrumb-item>
    </el-breadcrumb>
...
export default {
  ...
  methods: {
    ...
    userStateChanged(userInfo) {
      this.$confirm(`此操作将更新用户状态为：${userInfo.mg_state === true ? '正常' : '停用'}, 是否继续?`, '提示', {
